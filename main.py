...
print('''CML Image generator alpha 1.1 x64 新年特供版
...
''',
        'WELCOME-CMLIG x64 Copyright © 2022-2023 CreamML. All rights reserved.',
...
4.本程序能在32位Windows7及以上系统运行(注：我们暂时会提供win7兼容版，预计在2023年9月1日结束支持)，推荐在32位Windows10及以上系统运行(注意此副本为x64版本)，否则可能会导致程序出错，作者很少会修复该程序在Windows7或8.x系统上的bug(毕竟已经停止支持了)。
...
8.本程序部分版本自带“清除空格”程序，可以快速去掉文本空格与段落，在词云图转换器时，更快的完成准备过程
    ...
    1.28 alpha1.1.1
    增加win7兼容版，并确定于2023年9月结束该版本支持
    
    
    详细版本&版权信息：
    CML Image generator alpha 1.1 x64
    Copyright © 2022-2023 CreamML. All rights reserved.
